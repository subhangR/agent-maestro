...
describe('normalizeModelId', () => {
  it('passes active Fable 5 ids through unchanged (no longer retired)', () => {
  ...
  it('has no retired-model aliases configured', () => {
    expect(Object.keys(LEGACY_MODEL_ALIASES)).toHaveLength(0);
  });
});
