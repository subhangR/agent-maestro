...
const COMMAND_DEFINITIONS: Array<Omit<CommandCatalogEntry, 'syntax'>> = [
  ...
  { id: 'task:update', description: 'Update task status/priority', group: 'task', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  { id: 'task:complete', description: 'Mark task completed', group: 'task', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  { id: 'task:block', description: 'Mark task blocked', group: 'task', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  ...
  { id: 'session:spawn', description: 'Spawn new session', group: 'session', allowedModes: ALL_MODES },
  ...
  // Project commands
  { id: 'project:list', description: 'List projects', group: 'project', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  { id: 'project:get', description: 'Get project details', group: 'project', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  { id: 'project:create', description: 'Create project', group: 'project', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  { id: 'project:delete', description: 'Delete project', group: 'project', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  { id: 'project:set-master', description: 'Designate project as master', group: 'project', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  { id: 'project:unset-master', description: 'Remove master designation from project', group: 'project', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  ...
  // Team commands
  { id: 'team:list', description: 'List teams', group: 'team', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  { id: 'team:get', description: 'Get team details', group: 'team', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  { id: 'team:create', description: 'Create a new team', group: 'team', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  { id: 'team:edit', description: 'Edit a team', group: 'team', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  { id: 'team:delete', description: 'Delete a team (must be archived first)', group: 'team', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  { id: 'team:archive', description: 'Archive a team', group: 'team', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  { id: 'team:unarchive', description: 'Unarchive a team', group: 'team', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  { id: 'team:add-member', description: 'Add members to a team', group: 'team', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  { id: 'team:remove-member', description: 'Remove members from a team', group: 'team', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  { id: 'team:add-sub-team', description: 'Add a sub-team', group: 'team', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  { id: 'team:remove-sub-team', description: 'Remove a sub-team', group: 'team', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
  { id: 'team:tree', description: 'Show team hierarchy tree', group: 'team', allowedModes: ALL_MODES, promptModes: COORDINATOR_MODES },
