...
export interface SessionConfig {
  /** Model to use (e.g. sonnet, claude-fable-5, claude-opus-5, claude-sonnet-5, claude-opus-4-8, claude-opus-4-8[1m], gpt-5.6-sol, hermes-default, gemini-3-pro-preview) */
  model: string;
