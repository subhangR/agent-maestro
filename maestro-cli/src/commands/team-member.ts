...
export function registerTeamMemberCommands(program: Command) {
    ...
    teamMember.command('edit <teamMemberId>')
        ...
        .option('--model <model>', 'Update model (e.g. sonnet, claude-fable-5, claude-opus-5, claude-sonnet-5, claude-opus-4-8, claude-opus-4-8[1m], gpt-5.6-sol, hermes-default)')
    ...
    teamMember.command('create <name>')
        ...
        .option('--model <model>', 'Model to use (e.g. sonnet, claude-fable-5, claude-opus-5, claude-sonnet-5, claude-opus-4-8, claude-opus-4-8[1m], gpt-5.6-sol, hermes-default, or native model names)')
