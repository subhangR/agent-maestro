// Provider-neutral parser for the server→client TEXT control frames on a `/pty`
// WebSocket. The transport (terminal.ts) owns the connection lifecycle; this
// module owns only the wire contract, so it stays free of any provider- or
// transport-specific branching and is unit-testable in isolation.
//
