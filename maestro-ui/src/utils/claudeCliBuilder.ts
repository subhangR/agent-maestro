export interface ClaudeCliConfig {
  ...
  model?: 'sonnet' | 'sonnet[1m]' | 'opus' | 'opus[1m]' | 'haiku' | 'claude-fable-5' | 'claude-fable-5[1m]' | 'claude-opus-5' | 'claude-opus-5[1m]' | 'claude-opus-4-8' | 'claude-opus-4-8[1m]' | 'claude-opus-4-7' | 'claude-opus-4-7[1m]' | 'claude-sonnet-5' | 'claude-sonnet-5[1m]';
  systemPrompt?: string;
