// <l-i n="name" s="16"></l-i> — Lucide-style stroke icons as a tiny web component.
(function () {
  const P = {
  ...
  customElements.define('l-i', class extends HTMLElement {
    static get observedAttributes() { return ['n', 's']; }
    attributeChangedCallback() { this.draw(); }
    connectedCallback() { this.draw(); }
    draw() {
      const n = this.getAttribute('n') || 'circle-dot', s = this.getAttribute('s') || '16';
      if (!this.shadowRoot) this.attachShadow({ mode: 'open' });
      this.shadowRoot.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="' + s + '" height="' + s + '" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" style="display:block">' + (P[n] || P['circle-dot']) + '</svg>';
